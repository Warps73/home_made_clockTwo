...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(PIXEL_COUNT, PIXEL_PIN, NEO_GRB +
                                                                    NEO_KHZ800); // Paramètre l'objet strip qui correspond à toute les LED du ruban
...
// Definition des mots
// the words
int arrIlEst[] = {0, 2, 6, 8, 10};
int IL_EST_COUNT = 5;
int arrDeux[] = {14, 16, 17, 18};
int DEUX_COUNT = 4;
int arrQuatre[] = {38, 36, 34, 32, 30, 28};
int QUATRE_COUNT = 6;
int arrTrois[] = {26, 24, 22, 20, 19};
int TROIS_COUNT = 5;
int arrNeuf[] = {39, 41, 43, 45};
int NEUF_COUNT = 4;
int arrUne[] = {47, 49, 51};
int UNE_COUNT = 3;
int arrSept[] = {53, 55, 57, 58};
int SEPT_COUNT = 4;
int arrHuit[] = {78, 76, 74, 72};
int HUIT_COUNT = 4;
int arrSix[] = {70, 68, 66};
int SIX_COUNT = 3;
int arrCinq[] = {64, 62, 60, 59};
int CINQ_COUNT = 4;
int arrMidi[] = {79, 81, 83, 85};
int MIDI_COUNT = 4;
int arrDix[] = {83, 85, 87};
int DIX_COUNT = 3;
int arrMinuit[] = {89, 91, 93, 95, 97, 98};
int MINUIT_COUNT = 6;
int arrOnze[] = {118, 116, 114, 112};
int ONZE_COUNT = 4;
int arrHeure[] = {108, 106, 104, 102, 100};
int HEURE_COUNT = 5;
int arrHeures[] = {108, 106, 104, 102, 100, 99};
int HEURES_COUNT = 6;
int arrMoins[] = {119, 121, 123, 125, 127};
int MOINS_COUNT = 5;
int arrLe[] = {131, 133};
int LE_COUNT = 2;
int arrDixMinute[] = {135, 137, 138};
int DIX_MIN_COUNT = 3;
int arrEtQuart[] = {158, 156, 152, 150, 148, 146, 144};
int ET_QUART_COUNT = 7;
int arrQuart[] = {152, 150, 148, 146, 144};
int QUART_COUNT = 5;
int arrVingt[] = {159, 161, 163, 165, 167};
int VINGT_COUNT = 5;
int arrVingtCinq[] = {159, 161, 163, 165, 167, 169, 171, 173, 175, 177};
int VINGT_CINQ_COUNT = 10;
int arrCinqMinute[] = {171, 173, 175, 177};
int CINQ_MIN_COUNT = 4;
int arrEtMinute[] = {197, 195};
int ET_MIN_COUNT = 2;
int arrDemie[] = {191, 189, 187, 185, 183};
int DEMIE_COUNT = 5;
...
void setup() {
    ...
    if (rtc.lostPower()) {
        ...
        rtc.adjust(DateTime(2019, 22, 12, 12, 05, 30));
    }
